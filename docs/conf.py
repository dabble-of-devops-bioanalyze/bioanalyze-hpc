...
project = "BioAnalyze HPC"
copyright = "2022-%s, BioAnalyze AWS" % datetime.datetime.now().year
...
html_title = "BioAnalyze HPC"

html_context = {
    "github_user": "bioanalyze",
    "github_repo": "bioanalyze-hpc",
    "github_version": "main",
    "doc_path": "docs",
}
...
html_theme_options = dict(
    ...
    # canonical_url="",
    repository_url="https://github.com/bioanalyze-dabble-of-devops/bioanalyze-hpc",
    ...
    extra_navbar="",
    navbar_footer_text="",
    extra_footer="Would you like to be a beta tester or are you looking for Bioinformatics Infrastructure Consulting? Learn more at https://www.dabbleofdevops.com or email me directoy jillian@dabbleofdevops.com",
)
